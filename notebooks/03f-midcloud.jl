...
begin
	...
	f.savefig(plotsdir("mccmodel_TRP.png"),transparent=false,dpi=200)
	PNGFiles.load(plotsdir("mccmodel_TRP.png"))
end
...
begin
	...
	freg.savefig(plotsdir("mccmodel_reg.png"),transparent=false,dpi=200)
	PNGFiles.load(plotsdir("mccmodel_reg.png"))
end
...
begin
	...
	fbin.savefig(plotsdir("mccdiurnalmean.png"),transparent=false,dpi=200)
	load(plotsdir("mccdiurnalmean.png"))
end
...
begin
	...
	fA.savefig(plotsdir("mccdiurnalamplitude.png"),transparent=false,dpi=200)
	load(plotsdir("mccdiurnalamplitude.png"))
end
...
begin
	...
	fθ.savefig(plotsdir("mccdiurnalphase.png"),transparent=false,dpi=200)
	load(plotsdir("mccdiurnalphase.png"))
end
